...
import org.scoula.domain.UserDao;
import org.scoula.domain.UserDaoImpl;
...
class UserDaoTest {
  ...
  /**
   * 사용자 등록 기능 테스트 - UserVO 객체 생성 후 DAO를 통해 데이터베이스에 저장 - 영향받은 행 수가 1인지 검증
   *
   * @throws SQLException
   */
  @Test
  ...
  /**
   * 사용자 목록 조회 기능 테스트 - DAO를 통해 모든 사용자 목록 조회 - 결과를 콘솔에 출력 확인
   *
   * @throws SQLException
   */
  @Test
  ...
  /**
   * 특정 사용자 조회 기능 테스트 - ID로 특정 사용자 조회 (Optional 처리) - 결과가 null이 아닌지 검증 - 결과를 콘솔에 출력하여 확인
   *
   * @throws SQLException
   */
  @Test
  ...
  /**
   * 사용자 정보 수정 기능 테스트 - 먼저 기존 사용자 정보 조회 - 이름 필드 수정 후 DAO를 통해 업데이트 - 영향받은 행 수가 1인지 검증
   *
   * @throws SQLException
   */
  @Test
  ...
  /**
   * 사용자 삭제 기능 테스트 - ID로 사용자 삭제 - 영향받은 행 수가 1인지 검증
   *
   * @throws SQLException
   */
  @Test
